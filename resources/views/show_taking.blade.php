                    ...
                    <div class="card-body card-box">
                        ...
                        <div class="mb-3">
                            <form action="{{ route('searchDate') }}" method="POST">
                                ...
                                <input type="date" id="actionTimestamp" required name="actionTimestamp"
                                    class="form-control">
                                <button type="submit" class="btn btn-primary w-100">ابحث</button>
                            </form>
                        </div>
                        ...
                        @if ($stok != null)
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control bg-light" id="kmia" type="number" step="0.01"
                                        value="{{ $stok->kgg }}" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="kmia_1" class="form-label fw-bold">الكمية المتبقية (كغ)</label>
                                    <input class="form-control bg-light" id="kmia_1" type="number" step="0.01"
                                        value="{{ $stok->kg }}" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="kmia_2" class="form-label fw-bold">كمية المعبأ (كغ)</label>
                                    <input class="form-control" id="kmia_2" type="number" step="0.01"
                                        placeholder="ادخل كمية المعبأ بالكيلوا" onkeyup="calculateRemaining()">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="kmia_3" class="form-label fw-bold">الكمية الأصلية (كغ)</label>
                                    <input class="form-control bg-light" id="kmia_3" type="number" step="0.01"
                                        placeholder="الكمية الأصلية بالكيلوا" readonly>
                                </div>
                            </div>
                        @else
