...
@section('content')
    ...
    <form id="dailyRecordForm" class="m-auto for text-center mt-5" action="{{ route('createTheList') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label class="form-label">رقم الفاتوره</label>
            <input type="number" class="form-control" id="invoiceNumber" name="numberOFlist" value="{{ old('numberOFlist') }}"
    ...
    <div class="form-check form-check-inline p-3">
        ...
        <div class="text-center">
            <button class="btn btn-primary w-100" type="button" id="submitBtn">ارسال</button>
        </div>
    </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('submitBtn').addEventListener('click', function() {
        ...
        let photoText = photoInput.files.length > 0 ? photoInput.files[0].name : "لم يتم اختيار صورة";
